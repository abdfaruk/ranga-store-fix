...
const updatePrice = (id, value) => {
  ...
  const convertPriceText = parseFloat(value);
  // const totalStr = convertPriceText.value;
  // const convertPrice = parseFloat(totalStr).toFixed(2);
  const total = convertedOldPrice + convertPriceText;
